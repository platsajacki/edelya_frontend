...
const cookingEventBorsch = {
  ...
  meal_plan_items: [
    {
      id: "mpi-0000-0000-0000-0000-000000000001",
      dish: dishBorsch.id,
      date: "2026-03-10",
      cooking_event: "ce-00000000-0000-0000-0000-000000000001",
      position: 100,
      is_manual: false,
      created_at: now,
      updated_at: now,
    ...
    {
      id: "mpi-0000-0000-0000-0000-000000000002",
      dish: dishBorsch.id,
      date: "2026-03-11",
      cooking_event: "ce-00000000-0000-0000-0000-000000000001",
      position: 100,
...
const cookingEventSyrniki = {
  ...
  meal_plan_items: [
    {
      id: "mpi-0000-0000-0000-0000-000000000003",
      dish: dishSyrniki.id,
      date: "2026-03-11",
      cooking_event: "ce-00000000-0000-0000-0000-000000000002",
      position: 200,
      is_manual: false,
      created_at: now,
      updated_at: now,
...
const cookingEventSchi = {
  ...
  meal_plan_items: [
    {
      id: "mpi-0000-0000-0000-0000-000000000004",
      dish: dishSchi.id,
      date: "2026-03-12",
      cooking_event: "ce-00000000-0000-0000-0000-000000000003",
      position: 100,
      is_manual: false,
      created_at: now,
      updated_at: now,
    ...
    {
      id: "mpi-0000-0000-0000-0000-000000000005",
      dish: dishSchi.id,
      date: "2026-03-13",
      cooking_event: "ce-00000000-0000-0000-0000-000000000003",
      position: 100,
    ...
    {
      id: "mpi-0000-0000-0000-0000-000000000006",
      dish: dishSchi.id,
      date: "2026-03-14",
      cooking_event: "ce-00000000-0000-0000-0000-000000000003",
      position: 100,
...
const mealPlanItems = [
  {
    ...
    owner,
    date: "2026-03-10",
    cooking_event: cookingEventBorsch.id,
    position: 100,
    is_manual: false,
    created_at: now,
    updated_at: now,
  ...
  },
  {
    ...
    owner,
    date: "2026-03-11",
    cooking_event: cookingEventSyrniki.id,
    position: 200,
    is_manual: false,
    created_at: now,
    updated_at: now,
  },
  {
    ...
    owner,
    date: "2026-03-12",
    cooking_event: cookingEventSchi.id,
    position: 100,
    is_manual: false,
    created_at: now,
    updated_at: now,
